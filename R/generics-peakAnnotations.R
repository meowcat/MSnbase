...
#' @author stravsmi
#' @export
setGeneric("addPeakAnnotation", function(o, name, type, value=NA, FUN=NULL) standardGeneric("addPeakAnnotation"))

# Get and set individual annotation columns
#' @export
...
#' @export
setGeneric("peakAnnotations", function(o) standardGeneric("peakAnnotations"))
# this one we leave out for now
# setGeneric("peakAnnotations<-", function(o, df = NULL, name = NULL, class=NULL)
#   standardGeneric("peakAnnotations<-"))

#' @export
setGeneric("setData", function(o, df, ...) standardGeneric("setData"))
